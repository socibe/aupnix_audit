...
class FruitsVegetablesCategoryScreen extends StatefulWidget {
  const FruitsVegetablesCategoryScreen({super.key});

  @override
  State<FruitsVegetablesCategoryScreen> createState() =>
      _FruitsVegetablesCategoryScreenState();
}

class _FruitsVegetablesCategoryScreenState
    extends State<FruitsVegetablesCategoryScreen> {
  static const _text = Color(0xFF111111);
  static const _mutedText = Color(0xFF707070);
  static const _navBlack = Color(0xFF182326);
  ...
  static final List<CustomerProduct> _products =
      CustomerProductCatalog.products
          .where((product) => product.category == 'Fruits & Vegetables')
          ...
          children: [
                        ...
                        : SliverGrid(
                            delegate: SliverChildBuilderDelegate((
                              ...
                              return CustomerProductCard(
                                product: product,
                                isFavourite: _favouriteProducts.contains(
                                  product.name,
                                ),
            ...
            Positioned(
              ...
              child: ScrollAwareBottomNavigation(
                child: _FruitsVegetablesBottomNavigation(onHomeTap: _goHome),
              ),
            ),
          ],
        ),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: const Padding(
            ...
            child: Icon(Icons.search_rounded, size: 22, color: _mutedText),
          ),
          prefixIconConstraints: const BoxConstraints(
            minWidth: 48,
            minHeight: 48,
          ),
          hintText: 'Search In Fruits & Vegetables',
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Fresh produce from your nearest stores',
                style: TextStyle(
                  color: _text,
                  fontSize: 19,
  ...
  Widget _buildEmptySearchState() {
    return Container(
      ...
      child: const Column(
        children: [
          Icon(Icons.search_off_rounded, size: 42, color: _mutedText),
          SizedBox(height: 12),
          Text(
            'No Fruits & Vegetables products found',
...
class _FruitsVegetablesBottomNavigation extends StatelessWidget {
  const _FruitsVegetablesBottomNavigation({required this.onHomeTap});
          ...
          children: [
            ...
            _FruitsVegetablesNavItem(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const ProductSearchScreen(autoFocus: false),
                  ),
                );
              },
            ),
            const _FruitsVegetablesNavItem(
...
class _FruitsVegetablesNavItem extends StatelessWidget {
  const _FruitsVegetablesNavItem({
    required this.icon,
    required this.label,
    this.isActive = false,
  ...
  @override
  Widget build(BuildContext context) {
    const navBlack = _FruitsVegetablesBottomNavigation._navBlack;
    const navInactive = _FruitsVegetablesBottomNavigation._navInactive;
    ...
    return SizedBox(
      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            Icon(icon, size: 23, color: isActive ? navBlack : navInactive),
