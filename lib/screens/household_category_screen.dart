...
class HouseholdCategoryScreen extends StatefulWidget {
  const HouseholdCategoryScreen({super.key});

  @override
  State<HouseholdCategoryScreen> createState() =>
      _HouseholdCategoryScreenState();
}

class _HouseholdCategoryScreenState extends State<HouseholdCategoryScreen> {
  ...
  static final List<CustomerProduct> _products =
      CustomerProductCatalog.products
          .where((product) => product.category == 'Household')
          ...
          children: [
            ...
            Positioned(
              ...
              child: ScrollAwareBottomNavigation(
                child: _HouseholdBottomNavigation(onHomeTap: _goHome),
              ),
            ),
          ],
        ),
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Home essentials from your nearest stores',
                style: TextStyle(
                  color: _text,
                  fontSize: 19,
...
class _HouseholdBottomNavigation extends StatelessWidget {
  const _HouseholdBottomNavigation({required this.onHomeTap});
...
class _HouseholdNavItem extends StatelessWidget {
  const _HouseholdNavItem({
    required this.icon,
    required this.label,
    this.isActive = false,
  ...
  @override
  Widget build(BuildContext context) {
    const navBlack = _HouseholdBottomNavigation._navBlack;
    const navInactive = _HouseholdBottomNavigation._navInactive;
