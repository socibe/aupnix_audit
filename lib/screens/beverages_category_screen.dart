...
class _BeveragesCategoryScreenState extends State<BeveragesCategoryScreen> {
  ...
  static final List<CustomerProduct> _products =
      CustomerProductCatalog.products
          .where((product) => product.category == 'Beverages')
  ...
  List<CustomerProduct> get _displayedProducts {
    final query = _searchController.text.trim().toLowerCase();

    if (query.isEmpty) {
      return List<CustomerProduct>.from(_products);
    }
          ...
          children: [
            ...
            Positioned(
              ...
              child: ScrollAwareBottomNavigation(
                child: _BeveragesBottomNavigation(onHomeTap: _goHome),
              ),
            ),
          ],
        ),
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Refreshing drinks from your nearest stores',
                style: TextStyle(
                  color: _text,
                  fontSize: 19,
...
class _BeveragesBottomNavigation extends StatelessWidget {
  const _BeveragesBottomNavigation({required this.onHomeTap});
...
class _BeveragesNavItem extends StatelessWidget {
  const _BeveragesNavItem({
    required this.icon,
    required this.label,
    this.isActive = false,
  ...
  @override
  Widget build(BuildContext context) {
    const navBlack = _BeveragesBottomNavigation._navBlack;
    const navInactive = _BeveragesBottomNavigation._navInactive;
