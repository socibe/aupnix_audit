...
class SnacksCategoryScreen extends StatefulWidget {
  const SnacksCategoryScreen({super.key});

  @override
  State<SnacksCategoryScreen> createState() => _SnacksCategoryScreenState();
}

class _SnacksCategoryScreenState extends State<SnacksCategoryScreen> {
  ...
  static final List<CustomerProduct> _products =
      CustomerProductCatalog.products
          .where((product) => product.category == 'Snacks')
  ...
  List<CustomerProduct> get _displayedProducts => _filteredProducts;
          ...
          children: [
            ...
            Positioned(
              ...
              child: ScrollAwareBottomNavigation(
                child: _SnacksBottomNavigation(onHomeTap: _goHome),
              ),
            ),
          ],
        ),
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Tasty snacks from your nearest stores',
                style: TextStyle(
                  color: _text,
                  fontSize: 19,
...
class _SnacksBottomNavigation extends StatelessWidget {
  const _SnacksBottomNavigation({required this.onHomeTap});
...
class _SnacksNavItem extends StatelessWidget {
  const _SnacksNavItem({
    required this.icon,
    required this.label,
    this.isActive = false,
  ...
  @override
  Widget build(BuildContext context) {
    const navBlack = _SnacksBottomNavigation._navBlack;
    const navInactive = _SnacksBottomNavigation._navInactive;
