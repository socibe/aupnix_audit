...
class MilkDairyCategoryScreen extends StatefulWidget {
  const MilkDairyCategoryScreen({super.key});

  @override
  State<MilkDairyCategoryScreen> createState() =>
      _MilkDairyCategoryScreenState();
}

class _MilkDairyCategoryScreenState extends State<MilkDairyCategoryScreen> {
  ...
  static final List<CustomerProduct> _products =
      CustomerProductCatalog.products
          .where((product) => product.category == 'Milk & Dairy')
          ...
          children: [
            ...
            Positioned(
              ...
              child: ScrollAwareBottomNavigation(
                child: _MilkDairyBottomNavigation(onHomeTap: _goHome),
              ),
            ),
          ],
        ),
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Fresh dairy from your nearest stores',
                style: TextStyle(
                  color: _text,
                  fontSize: 19,
...
class _MilkDairyBottomNavigation extends StatelessWidget {
  const _MilkDairyBottomNavigation({required this.onHomeTap});
...
class _MilkDairyNavItem extends StatelessWidget {
  const _MilkDairyNavItem({
    required this.icon,
    required this.label,
    this.isActive = false,
  ...
  @override
  Widget build(BuildContext context) {
    const navBlack = _MilkDairyBottomNavigation._navBlack;
    const navInactive = _MilkDairyBottomNavigation._navInactive;
