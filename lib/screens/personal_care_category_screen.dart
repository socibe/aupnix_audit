...
class _PersonalCareCategoryScreenState
  ...
  static final List<CustomerProduct> _products =
      CustomerProductCatalog.products
          .where((product) => product.category == 'Personal Care')
          ...
          children: [
            ...
            Positioned(
              ...
              child: ScrollAwareBottomNavigation(
                child: _PersonalCareBottomNavigation(onHomeTap: _goHome),
              ),
            ),
          ],
        ),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintText: 'Search In Personal Care',
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Everyday personal care products from nearby stores',
                style: TextStyle(
                  color: _text,
                  fontSize: 19,
    ...
    return Container(
      ...
      child: const Column(
        children: [
          ...
          SizedBox(height: 12),
          Text(
            'No Personal Care products found',
...
class _PersonalCareBottomNavigation extends StatelessWidget {
  const _PersonalCareBottomNavigation({required this.onHomeTap});
...
class _PersonalCareNavItem extends StatelessWidget {
  const _PersonalCareNavItem({
    required this.icon,
    required this.label,
    this.isActive = false,
  ...
  @override
  Widget build(BuildContext context) {
    const navBlack = _PersonalCareBottomNavigation._navBlack;
    const navInactive = _PersonalCareBottomNavigation._navInactive;
